...
export class OrderDetailComponent {
  ...
  constructor(private pdfService: PdfService, private reviewService: ReviewService, private orderService: OrderService, private authService: AuthService, private router: Router, private tokenService: TokenService) {
