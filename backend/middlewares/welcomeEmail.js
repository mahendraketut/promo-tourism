...
//Reads the User Welcome Email Template
const readEmailTemplate = (userData, callback) => {
    const emailTemplatePath = join(__dirname, '../templates/welcomeEmail.html')
...
export const welcomeMail = (userData) => {
    console.log("masuk welcome mail");
    readEmailTemplate(userData, (err, replacedHtmlEmail) => {
        if (err) {
            ...
            transporter.sendMail({
                ...
                to: userData.email,
                subject: "Welcome to Promo Tourism",
