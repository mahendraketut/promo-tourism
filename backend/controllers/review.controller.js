...
export const getReviewByOrder = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(CreateSuccess(200, "Get review by order id", review));
  } catch (error) {
    return res
      .status(500)
...
export const getReviewAverageByProduct = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(
        CreateSuccess(200, "Get average review by product id", averageRating)
      );
  } catch (error) {
    return res
      .status(500)
      .json(CreateError(500, "Cannot get average review by product id", error));
  }
};
...
export const getMerchantReviewAverage = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(CreateSuccess(200, "Retreived merchant average", averageRating));
  } catch (error) {
    return res
      .status(500)
      .json(CreateError(500, "Unable to retreive merchant average", error));
  }
};
